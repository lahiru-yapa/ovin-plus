        ...
        <section class="project-detail-section">
            <div class="auto-container">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="image-column col-lg-12 col-md-12 col-sm-12">
                            ...
                            <body>
                                <section class="cases-section">
                                    <div class="auto-container">
                                        ...
                                        <div class="sec-title centered">
                                            ...
                                            <h2>Hotel management website project</h2>
                                        </div>
                                        <div class="row clearfix">
                                            ...
                                            <div class="case-block col-lg-4 col-md-6 col-sm-12">
                                                <div class="inner-box">
                                                    <div class="image">
                                                        <img src="{{asset('images/project/project1/demo-21.jpg')}}">
                                            ...
                                            <div class="case-block col-lg-4 col-md-6 col-sm-12">
                                                <div class="inner-box">
                                                    <div class="image">
                                                        <img src="{{asset('images/project/project1/HomePage2.jpg')}}">
                                                        <div class="overlay-box">

                                                            <div class="content">
                                                                <h4>hotel management website project</h4>
                                            ...
                                            <div class="case-block col-lg-4 col-md-6 col-sm-12">
                                                <div class="inner-box">
                                                    <div class="image">
                                                        <img src="{{asset('images/project/project1/HomePage4.jpg')}}">
                                                        <div class="overlay-box">
                                ...
                                <h3 class="text-center">See the gallery by clicking on the windows</h3>
                                <div class="wrapper">
                                    <div class="box item-1">
                                        <img src="{{asset('images/project/project1/feature.jpg')}}"
                                            style="height: 200px;">
                                        <div class="overlay ovrl-left ovrl-1"></div>
                                        <div class="overlay ovrl-right ovrl-1"></div>
                                        <div class="locker"><i class="arrow fa fa-arrows-h" aria-hidden="true"></i>
                                        </div>
                                    </div>
                                    <div class="box item-2">
                                        <img src="{{asset('images/project/project1/fearure2.png')}}"
                                            style="height: 200px;">
                                    ...
                                    <div class="box item-3">
                                        <img src="{{asset('images/project/project1/feature3.png')}}"
                                            style="height: 200px;">
                ...
                <div class="lower-section">
                    <h3 class="text-center">What is the aim of hotel management system?</h3>
                    <p>It seeks to improve efficiency and operational process performance, strategies are established so
                        that a hotel can be differentiated from what its competitors offer, better ways are sought to
                        improve user experience and customer satisfaction, etc.</p>
                    <h3 class="text-center">What are advantages of hotels?</h3>
                    <p>The entire smart hotel concept has emerged precisely because it offers benefits to both hotel
                        owners and guests. In particular, it can save hotel owners money on energy and maintenance
                        costs, while it can provide guests with an improved customer experience and a far greater degree
