        ...
        <section class="project-detail-section">
            <div class="auto-container">
                                    ...
                                    <div class="auto-container">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="case-block col-lg-4 col-md-6 col-sm-12">
                                                <div class="inner-box">
                                                    <div class="image">
                                                        <img src="{{asset('images/project/project3/driving2.jpg')}}">
                                            ...
                                            <div class="case-block col-lg-4 col-md-6 col-sm-12">
                                                <div class="inner-box">
                                                    <div class="image">
                                                        <img src="{{asset('images/project/project3/driving4.jpg')}}">
                                                        <div class="overlay-box">
                                            ...
                                            <div class="case-block col-lg-4 col-md-6 col-sm-12">
                                                <div class="inner-box">
                                                    <div class="image">
                                                        <img src="{{asset('images/project/project3/driving5.jpg')}}">
                                                        <div class="overlay-box">
                ...
                <div class="lower-section">
                    <h3 class="text-center">Why is it important for a company to have a website?</h3>
                    <p>Having a website and online presence strategy allows you to market your business online. A
                        website is also important because it helps to establish credibility as a business. ... A website
                        not only gives credibility but it also helps to give a positive impression that your company is
                        bigger and more successful.</p>
